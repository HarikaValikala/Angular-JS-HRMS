var hrmsApp = angular.module("myApp",['ui.router', 'ngCookies', 'hrmsApp.services', 'ui.bootstrap','ui.utils'])

hrmsApp.run(function ($rootScope, $location, $cookieStore, UserService) {
...
var services = angular.module('hrmsApp.services', ['ngResource']);
